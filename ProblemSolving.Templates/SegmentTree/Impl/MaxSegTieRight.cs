...
{
    [IncludeIfReferenced]
    public class MaxSegTieRight : MonoidSegTree<(int idx, long val), long>
    {
        public MaxSegTieRight(int size) : base(size)
        {
        }
        ...
        protected override (int idx, long val) Identity() => (-1, Int64.MinValue);
